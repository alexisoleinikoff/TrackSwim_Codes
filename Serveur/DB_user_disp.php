...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
    ...
    <body>
        ...
        <table border="0">
         ...
         <?php
            $personnes = $bdd->query("SELECT * FROM utilisateur ORDER BY Nom, Prenom ASC");
            foreach($personnes as $unepersonne) {
                echo "<TR><TD>".$unepersonne['Nom']."</TD><TD>".$unepersonne['Prenom']."</TD><TD>".$unepersonne['Date_de_naissance']."</TD><TD>".$unepersonne['ID_utilisateur']."</TD></TR>";
            }
        ?>
